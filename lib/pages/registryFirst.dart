...
import 'package:my_social_it_space/pages/RegistrySecond.dart';
import 'package:my_social_it_space/pages/Stories.dart';

class RegistryFirste extends StatelessWidget {
  const RegistryFirste({super.key});
